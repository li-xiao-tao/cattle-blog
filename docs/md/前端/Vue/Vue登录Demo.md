    ...
    <div class="login-wrap">
        <el-form class="login-container">
            ...
            <el-form-item label="账号">
                <el-input v-model="username" autocomplete="off" placeholder="登录账号" type="username"></el-input>
            </el-form-item>
            <el-form-item label="登录密码">
                <el-input v-model="password" autocomplete="off" placeholder="登录密码" type="password"></el-input>
            </el-form-item>
...
export default {
    ...
    methods: {
        async log() {
            ...
            const data = await (api.loginByUsername(params));
